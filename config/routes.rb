Rails.application.routes.draw do
  ...
  get '/user/:user_id/bookmarks', to: 'bookmarks#show'
  post '/user/:user_id/bookmarks/:product_id', to: 'bookmarks#create'
  delete '/user/:user_id/bookmarks/:product_id', to: 'bookmarks#destroy'
